...
```
```{r}
compare(result.sql, result.base,
        result.dplyr, result.data.table,
        allowAll = TRUE)
```
...
compare(result.base,
        result.dplyr, result.data.table,
        allowAll = TRUE)
compare(result.base, result.sql, allowAll = TRUE)
compare(result.dplyr, result.sql, allowAll = TRUE)
compare(result.data.table, result.sql, allowAll = TRUE)
```
